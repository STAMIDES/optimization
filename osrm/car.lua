...
function setup()
  return {
    properties = {
      ...
      u_turn_penalty                 = 35, -- Increased from 20 to account for real-world delays
    ...
    default_speed             = 8, -- Reduced from 10 to be more conservative
    oneway_handling           = true,
    side_road_multiplier      = 0.7, -- Reduced from 0.8 for more penalty on side roads
    turn_penalty              = 12, -- Increased from 7.5 to account for traffic lights and real delays
    speed_reduction           = 0.65, -- Reduced from 0.8 for more conservative speeds
    turn_bias                 = 1.075,
    ...
    speeds = Sequence {
      highway = {
        motorway        = 75, -- Reduced from 90 to account for real-world conditions
        motorway_link   = 35, -- Reduced from 45
        trunk           = 70, -- Reduced from 85  
        trunk_link      = 30, -- Reduced from 40
        primary         = 50, -- Reduced from 65
        primary_link    = 25, -- Reduced from 30
        secondary       = 45, -- Reduced from 55
        secondary_link  = 20, -- Reduced from 25
        tertiary        = 35, -- Reduced from 40
        tertiary_link   = 15, -- Reduced from 20
        unclassified    = 20, -- Reduced from 25
        residential     = 20, -- Reduced from 25
        living_street   = 8,  -- Reduced from 10
        service         = 12  -- Reduced from 15
      }
    },
